...
public class TargetCase {
    ...
    private final Result<EmptyTarget> result;

    @JsonIgnore
    private CustomItem ingredient;

    @JsonCreator
    public TargetCase(@JsonProperty("case") APIReference caseReference, @JsonProperty("result") Result<EmptyTarget> result) {
    ...
    @JsonProperty("result")
    public Result<EmptyTarget> getResult() {
        return result;
    }
    ...
    public Optional<Result<EmptyTarget>> check(ItemStack itemStack) {
