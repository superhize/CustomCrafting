...
public abstract class CustomCookingRecipe<C extends CustomCookingRecipe<C, T>, T extends CookingRecipe<?>> extends CustomRecipe<C, EmptyTarget> implements ICustomVanillaRecipe<T> {
